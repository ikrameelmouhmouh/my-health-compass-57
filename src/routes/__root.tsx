...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Calm, precise nutrition, fasting and training. Calibrate your metabolism, hit your targets." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "Apex — Calm precision for health & nutrition" },
      { name: "twitter:description", content: "Calm, precise nutrition, fasting and training. Calibrate your metabolism, hit your targets." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/209a1fe8-2d98-47fe-9ad8-6a8614cb52d1/id-preview-ab06ac6e--739bfba0-dfec-401f-b004-126355dc31f8.lovable.app-1782924316079.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/209a1fe8-2d98-47fe-9ad8-6a8614cb52d1/id-preview-ab06ac6e--739bfba0-dfec-401f-b004-126355dc31f8.lovable.app-1782924316079.png" },
    ],
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Space+Grotesk:wght@400;500;600;700&family=DM+Sans:opsz,wght@9..40,400;9..40,500;9..40,600;9..40,700&family=Sora:wght@400;500;600;700&family=Manrope:wght@400;500;600;700&display=swap",
      },
    ],
