...
const HINTS: Record<string, CameraHint> = {
  ...
  "chest-press-band": {
    ...
    bodyOrientation: "mannequin standing in a split stance facing away from the band anchor, a coloured resistance band running behind the back and under the armpits into both hands",
    startPose: "elbows bent and pulled back beside the chest, hands at chest height, band slack-to-taut behind the back",
    endPose: "both arms pressed straight forward at chest height, elbows nearly locked, band clearly stretched behind the back",
  },
  "chest-press-machine": {
    ...
    startPose: "elbows bent and pulled back, handles close to the chest, chest stretched",
    endPose: "arms pressed straight forward, elbows nearly locked, handles pushed fully away from the chest, weight stack visibly lifted",
  },
  "chest-press-trx": {
    ...
    startPose: "arms extended straight in front of the chest, body angled forward in a straight plank line",
    endPose: "elbows bent and flared out to about 45°, body lowered forward between the handles, chest stretched, body still in one straight line",
  },
  "chin-up": {
    label: "Vooraanzicht, hangend aan pull-up bar",
    angle: "straight front view, eye level with the chest, the full pull-up bar and its uprights visible in the same position in both frames",
    machineView: "fixed horizontal pull-up bar mounted on a frame, visible in the same position in both frames",
    bodyOrientation: "mannequin hanging from the bar with a supinated (underhand) shoulder-width grip, palms facing the mannequin, knees slightly bent and ankles crossed",
    startPose: "arms fully extended, body hanging straight down from the bar, shoulders stretched",
    endPose: "body pulled up until the chin is above the bar, elbows bent and driven down beside the ribs, back contracted",
  },
};
