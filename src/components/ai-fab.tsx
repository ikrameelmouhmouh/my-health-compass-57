...
export function AiFab() {
  ...
  // On the nutrition page there's already a "+" FAB at bottom-24 (~96px).
  // Raise the AI FAB so they don't overlap.
  const onNutrition = pathname.startsWith("/nutrition");
  const bottomClass = onNutrition
  ...
  return (
    <Link
      ...
      className={`fixed z-50 right-4 ${bottomClass} group`}
    >
